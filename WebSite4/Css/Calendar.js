...
document.write("<div id='meizzCalendarLayer' style='position: absolute; z-index: 99999999; width: " + (cal_Width+4).toString() + "px; height: 193px; display: none'>");
...
function returnDate() //根据日期格式等返回用户预约定的日期
{
